...
Overview
===
One of the remarkable things about inductive types is that they capture all of
propositional logic, first order logic, and more.

Thus, instead of defining _and_, _or_ and the other logical connectives as
built-in operators in the Lean language, they are just defined in the
standard library in terms of more primitive inductive types.
